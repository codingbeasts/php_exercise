...
<ol>
	...
	<li><b class="text-decoration-line-through">array_find() - Return the
			first element satisfying a callback function</b></li>
	<li><b class="text-decoration-line-through">array_find_key() - Return
			the key of the first matching element</b></li>
	<li><b class="text-decoration-line-through">array_is_list() — Check if
			an array is a list</b></li>
</ol>
...
<ol>
	...
	<li>array_chunk - Split array into chunk : <?= print '<pre>';
												print_r(array_chunk($arrayEx, 2)) . print '</pre>'; ?></li>
</ol>
